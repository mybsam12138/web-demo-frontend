        ...
        <v-col cols="12" sm="8" md="6" lg="4">
          <v-card class="pa-8" elevation="8" rounded="xl">
            ...
            <v-card-subtitle class="text-center mb-6">
              Choose a provider to continue(Only gitee can be used cause the server is in China, but the common package support different provider)
            </v-card-subtitle>
...
const handleOAuthLogin = async (provider: OAuthProvider) => {
  try {
    ...
    const redirectUrl = `${window.location.origin}/callback/success`
