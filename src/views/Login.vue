        ...
        <v-col cols="12" sm="8" md="6" lg="4">
          <v-card class="pa-8" elevation="8" rounded="xl">
            ...
            <v-card-subtitle class="text-center mb-6">
              Choose a provider to continue(Only Gitee is supported now because the server is in China, but the common package can support all oauth providers)
            </v-card-subtitle>
            ...
            <v-card-text>
              ...
              <v-btn
                ...
                class="mb-4 text-white"
                :disabled="loading"
                @click="handleOAuthLogin('OAUTH_GITHUB')"
              >
                <v-icon start>
                  <svg viewBox="0 0 24 24" width="20" height="20">
                    <path fill="white" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
